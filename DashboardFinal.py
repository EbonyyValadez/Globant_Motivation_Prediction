...
Original file is located at
    https://colab.research.google.com/drive/1mwZWMcTXjkPJLu6dEqvc6FRPpm8zoZom
"""
...
MODEL_NN_PATH = os.path.join(BASE_DIR, "my_model_3.keras")           # modelo NN
...
def main():
    ...
    if probs_vector is not None:
        ...
        fig_bar_m.update_yaxes(title="Probabilidad", range=[0, df_result["Probabilidad"].max() * 1.15])
        fig_bar_m.update_layout(margin=dict(t=120, b=50))
